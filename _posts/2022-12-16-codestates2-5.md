...
- em : font-size. 해당폰트의 대문자 M의 너비를 기준으로 함

##### background 속성과 background-color 속성 
- background 속성은 옵션 추가 가능
...
- 세로 정렬 : vertical-align
  - 부모 요소의 display 속성이 반드시 table-cell이어야 함
...
```
- #container의 너비는 300px이 아닌, 324px
